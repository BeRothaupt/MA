...
\begin{figure}[htb]
	...
	\node[rotate=-10, xshift=-.5cm, yshift=.2cm, fill=none] (glider) at (0,0) {\includegraphics[ width=2.5cm, keepaspectratio]{./src/pics/tikz/simpleGlider.pdf}};
	\draw[->,blue,rotate=-10,thick] (0,0) --  ++(6,0) node [right] {$\vec{v}_K$};
