...
\begin{figure}[hbt]
	...
	\end{tikzpicture}
	\caption{Results of synchronous value iteration (blue) and optimal control (red) in scenario 1}
...
\begin{figure}[hbt]
	...
	\node[rotate=-90, xshift=-.2cm, yshift=.1cm, fill=none] (glider) at (0,0.409*\textheight) {\includegraphics[ width=1.5cm, keepaspectratio]{./src/pics/tikz/simpleGlider.pdf}};
	\end{tikzpicture}
	\caption{Results of generalized policy iteration (blue) and optimal control (red) in scenario 2}
	\label{tikz:gpi500m}
\end{figure}
...
\begin{figure}[hbt]
	...
	\end{tikzpicture}
	\caption{Results of optimistic policy iteration (blue) and optimal control (red) in scenario 2}
	\label{tikz:opi500m}
\end{figure}
...
\begin{figure}[hbt]
	...
	\node[rotate=-90, xshift=-.2cm, yshift=.1cm, fill=none] (glider) at (0,0.409*\textheight) {\includegraphics[ width=1.5cm, keepaspectratio]{./src/pics/tikz/simpleGlider.pdf}};
	\end{tikzpicture}
	\caption{Results of value iteration (blue) and optimal control (red) in scenario 2}
	\label{tikz:vi500m}
\end{figure}
...
\begin{figure}[hbt]
	...
	\node[rotate=-90, xshift=-.2cm, yshift=.1cm, fill=none] (glider) at (0,0.409*\textheight) {\includegraphics[ width=1.5cm, keepaspectratio]{./src/pics/tikz/simpleGlider.pdf}};
	\end{tikzpicture}	
	\caption{Results of value iteration (blue) and optimal control (red) in scenario 3}
	\label{tikz:vi1000m}
\end{figure}
