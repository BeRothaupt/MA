...
%		}
		...
		\fill[green] (0,7) circle (3.5pt) ;
		\fill[green] (5.5,12) circle (3.5pt) ;
	\end{tikzpicture}
	\caption{The discretized state space in all 2D scenarios. For the grid cell at $x_4$ and $z_3$, the grid for the speed vector is drawn.}
