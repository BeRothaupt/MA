...
The second curse of dimensionality only occurs in stochastic environments, the two other curses can occur in any environment, where the number of actions and/or states is high.
